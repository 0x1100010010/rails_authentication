...
class SignUpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sign_up" do
    assert_difference('SignUp.count') do
      post sign_ups_url, params: { sign_up: { email: @sign_up.email, password: @sign_up.password, username: @sign_up.username } }
    end
  ...
  test "should update sign_up" do
    patch sign_up_url(@sign_up), params: { sign_up: { email: @sign_up.email, password: @sign_up.password, username: @sign_up.username } }
